...
public class AmazonEventRecordsTest {
    ...
    public void setUp() throws Exception {
        ...
        final AmazonEventRecord record = new AmazonEventRecord("2.0", "aws:s3",
                "us-east-1", "1970-01-01T00:00:00.000Z", "event-type", s3);
    ...
    public void serializesToJSON() throws Exception {
        ...
        final String expected = MAPPER.writeValueAsString(MAPPER.readValue(
                FixtureHelpers.fixture("fixtures/amazon_event_records.json"),
