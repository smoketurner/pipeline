...
public class EventResourceTest {
  ...
  private static final InstrumentedSseBroadcaster broadcaster =
      mock(InstrumentedSseBroadcaster.class);

  @ClassRule
  public static final ResourceTestRule resources = ResourceTestRule.builder()
      .addProvider(SseFeature.class).addResource(new EventResource(broadcaster)).build();

  @Test
  public void testGetEventsUnavailable() throws Exception {
    final Response response = resources.client().target("/v1/events").request().get();
