...
public final class AmazonEventRecord {
  ...
  @JsonCreator
  public AmazonEventRecord(@JsonProperty("eventVersion") final String eventVersion,
  ...
  public boolean equals(final Object obj) {
    ...
    return Objects.equals(eventVersion, other.eventVersion)
        ...
        && Objects.equals(awsRegion, other.awsRegion) && Objects.equals(eventTime, other.eventTime)
        && Objects.equals(eventName, other.eventName) && Objects.equals(s3, other.s3);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventVersion, eventSource, awsRegion, eventTime, eventName, s3);
  }

  @Override
  public String toString() {
    return MoreObjects.toStringHelper(this).add("eventVersion", eventVersion)
        .add("eventSource", eventSource).add("awsRegion", awsRegion).add("eventTime", eventTime)
        .add("eventName", eventName).add("s3", s3).toString();
  }
}
